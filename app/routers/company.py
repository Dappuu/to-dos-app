...
async def get_All_Companies(
    ...
    conditions = SearchCompanyModel(company_id, company_name, page, size)
...
@router.put("/{company_id}", status_code=status.HTTP_201_CREATED, response_model=CompanyViewModel)
